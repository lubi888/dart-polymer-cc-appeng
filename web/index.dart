...
// var el1 = document.body.createElement('dart-cc1');
  ...
  document.body.children.add(myTweetElement);   //mainContent.children.add(myTweetElement);
    var myTweetElementVar = new Element.tag ('what-ver');
  document.body.children.add(myTweetElementVar);   //mainContent.children.add(myTweetElement);
